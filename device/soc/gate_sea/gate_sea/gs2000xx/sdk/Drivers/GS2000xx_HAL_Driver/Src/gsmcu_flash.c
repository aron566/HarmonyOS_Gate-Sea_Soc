...
RAMFUNC uint8_t FLASH_GetFalshStatus(uint8_t regx)
{
  ...
  {
    case 2:
      FTSPI->CMD3 = (READ_STATUS_REG2 << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x01UL << 3) | (0x01UL << 2) | (0x00UL << 1);
      break;
    case 3:
      FTSPI->CMD3 = (READ_STATUS_REG3 << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x01UL << 3) | (0x01UL << 2) | (0x00UL << 1);
      break;
    default:
      FTSPI->CMD3 = (READ_STATUS_REG1 << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x01UL << 3) | (0x01UL << 2) | (0x00UL << 1);
      break;
  }
...
RAMFUNC void FLASH_WriteFlashStatus(uint8_t regx, uint32_t data)
{
  ...
  FTSPI->CMD1 = (0x00UL << 28) | (0x01UL << 24) | (0x00UL << 16) | (0x00UL << 0);
  FTSPI->CMD2 = 0;
  FTSPI->CMD3 = (0x50 << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x00UL << 3) | (0x00UL << 2) | (0x01UL << 1);
  while ((FTSPI->ISR & 0x01) == 0x00)
    ;
  FTSPI->ISR = 0x01;
  ...
  {
    case 2:
      FTSPI->CMD3 = (WRITE_STATUS_REG2 << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x01UL << 3) | (0x00UL << 2) | (0x1UL << 1);
      break;
    case 3:
      FTSPI->CMD3 = (WRITE_STATUS_REG3 << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x01UL << 3) | (0x00UL << 2) | (0x1UL << 1);
      break;
    default:
      FTSPI->CMD3 = (WRITE_STATUS_REG1 << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x01UL << 3) | (0x00UL << 2) | (0x1UL << 1);
      break;
  }
...
RAMFUNC void FLASH_WriteFlashStatusNoVolatile(uint8_t regx, uint32_t data)
{
  ...
  FTSPI->CMD1 = (0x00UL << 28) | (0x01UL << 24) | (0x00UL << 16) | (0x00UL << 0);
  FTSPI->CMD2 = 0;
  FTSPI->CMD3 = (0x06 << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x00UL << 3) | (0x00UL << 2) | (0x01UL << 1);
  while ((FTSPI->ISR & 0x01) == 0x00)
    ;
  FTSPI->ISR = 0x01;
...
RAMFUNC void FLASH_EarseBlock(uint32_t block_start)
{
  ...
  FTSPI->CMD1 = (0x00UL << 28) | (0x01UL << 24) | (0x00UL << 16) | (0x00UL << 0);
  FTSPI->CMD2 = 0;
  FTSPI->CMD3 = (WRITE_ENABLE << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x00UL << 3) | (0x00UL << 2) | (0x01UL << 1);
  while ((FTSPI->ISR & 0x01) == 0x00)
    ;
  FTSPI->ISR = 0x01;
  ...
  FTSPI->CMD2 = 0;
  FTSPI->CMD3 = (SECTION_ERASE << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x00UL << 3) | (0x00UL << 2) | (0x01UL << 1);
  while ((FTSPI->ISR & 0x01) == 0x00)
    ;
  FTSPI->ISR = 0x01;
...
RAMFUNC void FLASH_ProgramPackageData(uint32_t Package_start, uint32_t *pdata, uint32_t pagewords)
{
  ...
  FTSPI->CMD3 = (PAGE_PROGRAM << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x00UL << 3) | (0x00UL << 2) | (0x01UL << 1);
  while (1)
  {
...
RAMFUNC void FLASH_GetPackageData(uint32_t Package_start, uint32_t *pdata, uint32_t wordsize)
{
  ...
  FTSPI->CMD3 = (READ_DATA << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x00UL << 3) | (0x00UL << 2) | (0x00UL << 1);
  //
  while (1)
  {
    currentdatalen = leavedatalen > 0x20 ? 0x20 : leavedatalen;
...
RAMFUNC void FLASH_GetSecurity(uint32_t reg_num, uint32_t addr, uint32_t *pdata, uint32_t wordsize)
{
  ...
  FTSPI->CMD2 = wordsize << 2;
  FTSPI->CMD3 = (0x48 << 24) | (0x00UL << 16) | (0x00UL << 8) | (0x00UL << 5) | (0x00UL << 4) | (0x00UL << 3) | (0x00UL << 2) | (0x00UL << 1);
  //
  while (1)
  {
    currentdatalen = leavedatalen > 0x20 ? 0x20 : leavedatalen;
